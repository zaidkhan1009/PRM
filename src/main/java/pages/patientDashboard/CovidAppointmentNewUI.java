...
public class CovidAppointmentNewUI {
    ...
    @FindBy(xpath = "//span[text()='Have you suffered from any of these in the past 2 weeks?']/preceding-sibling::span/span[contains(@class,'red astrick')]")
    private WebElement covidQue_1;
    @FindBy(xpath = "//span[contains(text(),'Have you suffered from any of these in the past 2 weeks?')]/../following-sibling::div//label[text()='High Fever']")
    private WebElement highFever;
    @FindBy(xpath = "//span[contains(text(),'Have you suffered from any of these in the past 2 weeks?')]/../following-sibling::div//label[text()='Difficulty in Breathing']")
    private WebElement difficultyBreathing;
    @FindBy(xpath = "//span[contains(text(),'Have you suffered from any of these in the past 2 weeks?')]/../following-sibling::div//label[text()='Cough / Sore Throat']")
    private WebElement coughSoreThroat;
    @FindBy(xpath = "//span[contains(text(),'Have you suffered from any of these in the past 2 weeks?')]/../following-sibling::div//label[text()='Sneezing / Running Nose']")
    private WebElement sneezingRunningNose;
    @FindBy(xpath = "//span[contains(text(),'Have you suffered from any of these in the past 2 weeks?')]/../following-sibling::div//label[text()='None of Them']")
    private WebElement noneOfThem;
    @FindBy(xpath = "//span[text()='Have you been asked to go in quarantine during past 2 weeks?']/preceding-sibling::span/span[contains(@class,'red astrick')]")
    private WebElement covidQue_2;
    @FindBy(xpath = "//span[text()='Have you been asked to go in quarantine during past 2 weeks?']/../following-sibling::div//label[text()='Yes']")
    private WebElement yesBtnCovidQue_2;
    @FindBy(xpath = "//span[text()='Have you been asked to go in quarantine during past 2 weeks?']/../following-sibling::div//label[text()='No']")
    private WebElement noBtnCovidQue_2;
    @FindBy(xpath = "//span[text()='Any of your family members found COVID positive in last few months?']/preceding-sibling::span/span[contains(@class,'red astrick')]")
    private WebElement covidQue_3;
    @FindBy(xpath = "//span[text()='Any of your family members found COVID positive in last few months?']/../following-sibling::div//label[text()='Yes']")
    private WebElement yesBtnCovidQue_3;
    @FindBy(xpath = "//span[text()='Any of your family members found COVID positive in last few months?']/../following-sibling::div//label[text()='No']")
    private WebElement noBtnCovidQue_3;
    @FindBy(xpath = "//span[text()='Have you travelled to any other state within India in the past 2 weeks?']/preceding-sibling::span/span[contains(@class,'red astrick')]")
    private WebElement covidQue_4;
    @FindBy(xpath = "//span[text()='Have you travelled to any other state within India in the past 2 weeks?']/../following-sibling::div//label[text()='Yes']")
    private WebElement yesBtnCovidQue_4;
    @FindBy(xpath = "//span[text()='Have you travelled to any other state within India in the past 2 weeks?']/../following-sibling::div//label[text()='No']")
    private WebElement noBtnCovidQue_4;
    @FindBy(xpath = "//span[text()='Have you lived or travelled to any foreign country in the past 2 weeks?']/preceding-sibling::span/span[contains(@class,'red astrick')]")
    private WebElement covidQue_5;
    @FindBy(xpath = "//span[text()='Have you lived or travelled to any foreign country in the past 2 weeks?']/../following-sibling::div//label[text()='Yes']")
    private WebElement yesBtnCovidQue_5;
    @FindBy(xpath = "//span[text()='Have you lived or travelled to any foreign country in the past 2 weeks?']/../following-sibling::div//label[text()='No']")
    private WebElement noBtnCovidQue_5;
    @FindBy(xpath = "//span[text()='Have you met someone who recently returned from Corona active country?']/preceding-sibling::span/span[contains(@class,'red astrick')]")
    private WebElement covidQue_6;
    @FindBy(xpath = "//span[text()='Have you met someone who recently returned from Corona active country?']/../following-sibling::div//label[text()='Yes']")
    private WebElement yesBtnCovidQue_6;
    @FindBy(xpath = "//span[text()='Have you met someone who recently returned from Corona active country?']/../following-sibling::div//label[text()='No']")
    private WebElement noBtnCovidQue_6;
    @FindBy(xpath = "//span[text()='Have you been in contact with a suspected/confirmed case of COVID-19?']/preceding-sibling::span/span[contains(@class,'red astrick')]")
    private WebElement covidQue_7;
    @FindBy(xpath = "//span[text()='Have you been in contact with a suspected/confirmed case of COVID-19?']/../following-sibling::div//label[text()='Yes']")
    private WebElement yesBtnCovidQue_7;
    @FindBy(xpath = "//span[text()='Have you been in contact with a suspected/confirmed case of COVID-19?']/../following-sibling::div//label[text()='No']")
    private WebElement noBtnCovidQue_7;
    @FindBy(xpath = "//span[text()='Have you been in a gathering or a meeting with unacquainted people or where people have returned from foreign country?']/preceding-sibling::span/span[contains(@class,'red astrick')]")
    private WebElement covidQue_8;
    @FindBy(xpath = "//span[text()='Have you been in a gathering or a meeting with unacquainted people or where people have returned from foreign country?']/../following-sibling::div//label[text()='Yes']")
    private WebElement yesBtnCovidQue_8;
    @FindBy(xpath = "//span[text()='Have you been in a gathering or a meeting with unacquainted people or where people have returned from foreign country?']/../following-sibling::div//label[text()='No']")
    private WebElement noBtnCovidQue_8;
    @FindBy(xpath = "//span[text()='History of any medicine intake during last 2 weeks?']/preceding-sibling::span/span[contains(@class,'red astrick')]")
    private WebElement covidQue_9;
    @FindBy(xpath = "//span[text()='History of any medicine intake during last 2 weeks?']/../following-sibling::div//label[text()='Yes']")
    private WebElement yesBtnCovidQue_9;
    @FindBy(xpath = "//span[text()='History of any medicine intake during last 2 weeks?']/../following-sibling::div//label[text()='No']")
    ...
    @FindBy(xpath = "//span[contains(text(),'What is Your Temperature (In Fahrenheit)?')]/../following-sibling::div//input[contains(@placeholder,'enter details')]")
    ...
    @FindBy(xpath = "//span[contains(text(),'What is your Oximeter level?')]/../following-sibling::div//input[contains(@placeholder,'enter details')]")
    private WebElement textFieldsCovidQue_11;
    @FindBy(xpath = "//span[text()='Do you want to update the patient status manually?']/preceding-sibling::span[@class='hdrCount']")
    private WebElement covidQue_12;
    @FindBy(xpath = "//span[contains(text(),'Do you want to update the patient status manually?')]/../following-sibling::div//label[@data-desc='Treatment Allowed']")
    private WebElement greenBtnCovidQue_12;
    @FindBy(xpath = "//span[contains(text(),'Do you want to update the patient status manually?')]/../following-sibling::div//label[@data-desc='Treat with Caution']")
    private WebElement yellowBtnCovidQue_12;
    @FindBy(xpath = "//span[contains(text(),'Do you want to update the patient status manually?')]/../following-sibling::div//label[@data-desc='Treatment not Allowed']")
