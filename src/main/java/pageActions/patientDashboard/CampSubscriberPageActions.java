...
public class CampSubscriberPageActions extends BaseClass {
	...
	public static void regionDropDown() {
		...
		flag1 = checkedWebElementDisplayed(campSubscriberPage.getRegionHeader())
				&& checkedWebElementDisplayed(campSubscriberPage.getRegionDropDown())
				&& BaseClass.firstSelectedOption(campSubscriberPage.getRegionDropDown()).contains("Select Region");
	...
	public static void zoneDropDown() {
		...
		Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getZoneDropDown())
				&& checkedWebElementDisplayed(campSubscriberPage.getZoneHeader()));
	}
	...
	public static void campaignDropDown() {
		...
		boolean flag1, flag2, match = false;
		flag1 = checkedWebElementDisplayed(campSubscriberPage.getCampaignDropDown())
				&& BaseClass.firstSelectedOption(campSubscriberPage.getCampaignDropDown()).contains("Select Campaign")
				&& checkedWebElementDisplayed(campSubscriberPage.getCampaignHeader());
		String[] exp = { "Select Campaign", "Aatman", "Braces", "CRM", "CSR", "Digital", "Generic Dental", "Implant",
				"International Patients", "Kids Campaign", "Other", "Practo", "Pratapa Rao", "Preventive Oral Health",
				"Ritika Singh", "Smile Makeover", "Special Day Offer", "TTYD" };
	...
	public static void sourceDropDown() {
		...
		boolean flag1, flag2, match = false;
		flag1 = checkedWebElementDisplayed(campSubscriberPage.getSourceDropDown())
				&& BaseClass.firstSelectedOption(campSubscriberPage.getSourceDropDown()).contains("Select Source")
				&& checkedWebElementDisplayed(campSubscriberPage.getSourceHeader());
		String[] exp = { "Select Source", "Ad-Newspaper", "Ad-Radio", "Branding", "Camp-CSR", "Camp-Market",
				"CDOP-Corporate", "CDOP-Coupon/Leaflet", "CDOP-Retail", "CDOP-RWA", "CDOP-School", "Chat",
				"Direct Email", "Existing Patient", "Facebook", "Google", "In-App", "In-Clinic", "Just Dial",
				"Nearbuy Deals", "Other", "Practo", "SEM", "SMS", "Walk-In", "Website", "Yahoo" };
	...
	public static void subSourceTextFields() {
		...
		Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getSubSourceHeader())
				&& checkedWebElementDisplayed(campSubscriberPage.getSubSourceTextField())
				&& campSubscriberPage.getSubSourceTextField().getAttribute("placeholder").contains("sub source"));
	}
	...
	public static void selectSubscriberSourceErr() {
		...
		Assert.assertTrue(
				campSubscriberPage.getSelectSubscriberSourceErr().getText().contains("Select Subscriber's Source"));
	}

	public static void enterSubSourceErr() {
		BaseClass.waitForElementVisibility(campSubscriberPage.getEnterSubSourceErr());
	...
	public static void nameTextFields() {
		...
		Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getName())
				&& checkedWebElementDisplayed(campSubscriberPage.getHeaderName())
				&& campSubscriberPage.getName().getAttribute("placeholder").contains("name"));
	}
	...
	public static void genderRadio() {
		...
		Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getHeaderGender())
				&& checkedWebElementDisplayed(campSubscriberPage.getMaleText())
				&& checkedWebElementDisplayed(campSubscriberPage.getFemaleText())
				&& checkedWebElementDisplayed(campSubscriberPage.getOtherText()));
	}
	...
	public static void dobTextFields() {
		...
		Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getDob())
				&& checkedWebElementDisplayed(campSubscriberPage.getHeaderDob())
				&& campSubscriberPage.getDob().getAttribute("placeholder").contains("dd-mm-yyyy"));
	}
	...
	public static void ageTextFields() {
		...
		Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getAge())
				&& checkedWebElementDisplayed(campSubscriberPage.getHeaderAge())
				&& campSubscriberPage.getAge().getAttribute("placeholder").contains("age"));
	}
	...
	public static void emailTextFields() {
		...
		Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getEmail())
				&& checkedWebElementDisplayed(campSubscriberPage.getHeaderEmail())
				&& campSubscriberPage.getEmail().getAttribute("placeholder").contains("email"));
	}
	...
	public static void mobileTextFields() {
		BaseClass.waitForPageLoad();
		Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getMobile())
				&& checkedWebElementDisplayed(campSubscriberPage.getHeaderMobile())
				&& campSubscriberPage.getMobile().getAttribute("placeholder").contains("enter 10 digit mobile no"));
	}
	...
	public static void enterMobile(String mobileSub) {
		...
		try {
			Thread.sleep(5000);
			scrollToView(campSubscriberPage.getdropDown());
			BaseClass.waitForElementToBeClickable(campSubscriberPage.getdropDown());
			campSubscriberPage.getdropDown().click();
		} catch (Exception e) {
	...
	public static void notifications() {
		BaseClass.waitForPageLoad();
		Assert.assertTrue(campSubscriberPage.getCallCheckBox().isSelected()
				&& checkedWebElementDisplayed(campSubscriberPage.getCallText())
				&& campSubscriberPage.getSmsCheckBox().isSelected()
				&& checkedWebElementDisplayed(campSubscriberPage.getSmsText())
				&& !campSubscriberPage.getEmailCheckBox().isSelected()
				&& checkedWebElementDisplayed(campSubscriberPage.getEmailText()));
	}
	...
	public static void interestLevel() {
		...
		Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getInterestLevel())
				&& !campSubscriberPage.getIntrstLevelLow().isSelected()
				&& checkedWebElementDisplayed(campSubscriberPage.getIntrstLevelLowText())
				&& !campSubscriberPage.getIntrstLevelMedium().isSelected()
				&& checkedWebElementDisplayed(campSubscriberPage.getIntrstLevelMediumText())
				&& !campSubscriberPage.getIntrstLevelHigh().isSelected()
				&& checkedWebElementDisplayed(campSubscriberPage.getIntrstLevelHighText()));
	}
	...
	public static void findingBox(String findingsSub, String intrestname, String infname, String age, String jawtype) {
		System.out.println(campSubscriberPage.getFindingsBox().get(1).getText());
		...
		for (int i = 0; i < count; i++) {
			...
			if (campSubscriberPage.getFindingsBox().get(i).getText().trim().contains(findingsSub)) {
				campSubscriberPage.getFindingsBox().get(i).click();
				for (int j = 0; j < campSubscriberPage.getintrestLeval().size(); j++) {
					if (campSubscriberPage.getintrestLeval().get(j).getText().contains(intrestname)) {
						campSubscriberPage.getintrestLeval().get(j).click();
					}
				}
				for (int k = 0; k < campSubscriberPage.getotherInfo().size(); k++) {
					if (campSubscriberPage.getotherInfo().get(k).getAttribute("value").contains(infname)) {
						campSubscriberPage.getotherInfo().get(k).click();
					}
				}
//            	for(int m=0;m<campSubscriberPage.selectupperlowerjaw(jawtype,age).size();m++) {
//            		campSubscriberPage.selectupperlowerjaw("","").get(i).click();;
//            	}
...
//                Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getFindingsBox().get(i)));
	...
	public static void headerMembership() {
		BaseClass.waitForPageLoad();
		Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getMembershipHeader())
				&& checkedWebElementDisplayed(campSubscriberPage.getMembershipDrpDwnHeader()));
	}

	public static void membershipDropDown() {
		BaseClass.waitForPageLoad();
		campSubscriberPage.getMembershipDropDown().click();
		Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getMembershipDropDown())
				&& checkedWebElementDisplayed(campSubscriberPage.getSearchBoxMembership())
				&& checkedWebElementDisplayed(campSubscriberPage.getDentalHealthPlan2())
				&& checkedWebElementDisplayed(campSubscriberPage.getDentalHealthPlan3()));
	}
	...
	public static void paymentMode() {
		BaseClass.waitForPageLoad();
		Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getHeaderPaymentMode())
				&& checkedWebElementDisplayed(campSubscriberPage.getAmountHeader()));
	}
	...
	public static void cardMode() {
		...
		if (!campSubscriberPage.getCard().isSelected()) {
			...
			Assert.assertTrue(!(str == null));
			boolean flag1, flag2, match = false;
			flag1 = checkedWebElementDisplayed(campSubscriberPage.getSubType())
					&& checkedWebElementDisplayed(campSubscriberPage.getSubTypeDropDown())
					&& BaseClass.firstSelectedOption(campSubscriberPage.getSubTypeDropDown()).contains("Select Type");
	...
	public static void error(String error_msg) {
		BaseClass.waitForPageLoad();
		BaseClass.visibilityOfAllElements(campSubscriberPage.getErrorMsg());
	int size=campSubscriberPage.getErrorMsg().size();
		for(int j=0;j<size;j++) {
			if(campSubscriberPage.getErrorMsg().get(j).getText().contains(error_msg)) {
		      Assert.assertEquals(campSubscriberPage.getErrorMsg().get(j).getText().trim(), error_msg);
			}
		}
	}
	...
	public static void inputListColumn() {
		...
		try {
			Thread.sleep(5000);
			Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getNamePatientId())
					&& checkedWebElementDisplayed(campSubscriberPage.getMobileEmail())
					&& checkedWebElementDisplayed(campSubscriberPage.getFindings())
					&& checkedWebElementDisplayed(campSubscriberPage.getMemberships())
					&& checkedWebElementDisplayed(campSubscriberPage.getPaymentMode())
					&& checkedWebElementDisplayed(campSubscriberPage.getAmountTabular())
					&& checkedWebElementDisplayed(campSubscriberPage.getAction()));
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	}
	...
	public static void mobileEmailInput(String mobileInput, String emailInput) {
		...
		for (WebElement row : campSubscriberPage.getRowCampSubs()) {
			...
			Assert.assertTrue(
					split[0].trim().equalsIgnoreCase(mobileInput) && split[1].trim().equalsIgnoreCase(emailInput));
		}
	}
	...
	public static void openView(String subscriber) {
		...
		for (WebElement row : campSubscriberPage.getRowCampSubs()) {
			...
			WebElement view = driver.findElement(By.xpath("//span[contains(text(),'" + subs
					+ "')]/../../following-sibling::td//span[@class='actn-icn view']"));
	...
	public static void headerViewModal() {
		...
		try {
			Thread.sleep(8000);
			Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getDetails())
					&& checkedWebElementDisplayed(campSubscriberPage.getPersonalInfo())
					&& checkedWebElementDisplayed(campSubscriberPage.getCampInfoView()));
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	}
	...
	public static void enquiryDetails(String findingsSub, String intrestname, String infname,String secfindingsSub,String secintrestname) {
		BaseClass.visibilityOfListLocated(campSubscriberPage.getFindingsBox());
	    Assert.assertTrue(campSubscriberPage.getPrimaryEnquiry().isDisplayed());
		int count = campSubscriberPage.getFindingsBox().size();
		for (int i = 0; i < count; i++) {
			...
			if (campSubscriberPage.getFindingsBox().get(i).getText().trim().contains(findingsSub)) {
				...
				BaseClass.visibilityOfListLocated(campSubscriberPage.getintrestLeval());
				...
				BaseClass.visibilityOfListLocated(campSubscriberPage.getotherInfo());
				for (int k = 0; k < campSubscriberPage.getotherInfo().size(); k++) {
					if (campSubscriberPage.getotherInfo().get(k).getAttribute("value").contains(infname)) {
						campSubscriberPage.getotherInfo().get(k).click();
					}
				}
				BaseClass.waitForElementToBeClickable(campSubscriberPage.getAllTeeth());
				campSubscriberPage.getAllTeeth().click();
				BaseClass.waitForElementToBeClickable(campSubscriberPage.getsave());
				campSubscriberPage.getsave().click();
				count=count-1;
//                Assert.assertTrue(checkedWebElementDisplayed(campSubscriberPage.getFindingsBox().get(i)));
			}
		...
		BaseClass.waitForElementToBeClickable(campSubscriberPage.getSecondaryEnquiry());
	    Assert.assertTrue(campSubscriberPage.getSecondaryEnquiry().isDisplayed());
		campSubscriberPage.getSecondaryEnquiry().click();
//		BaseClass.visibilityOfListLocated(campSubscriberPage.getFindingsBox());
//		int count1 = campSubscriberPage.getFindingsBox().size();
		for (int i = 0; i < count; i++) {

			if (campSubscriberPage.getFindingsBox().get(i).getText().trim().contains(secfindingsSub)) {
				campSubscriberPage.getFindingsBox().get(i).click();
				for (int j = 0; j < campSubscriberPage.getintrestLeval().size(); j++) {
					if (campSubscriberPage.getintrestLeval().get(j).getText().contains(secintrestname)) {
						campSubscriberPage.getintrestLeval().get(j).click();
					}
				}
				for (int k = 0; k < campSubscriberPage.getotherInfo().size(); k++) {
