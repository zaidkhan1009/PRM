...
public class EventListingPageActions extends BaseClass {
	...
	public static void verifyOptionInEventTypeFilter() {
		...
		for (WebElement eventType : eventTypeList) {
			if (eventType.getText().equals("Select Type") || eventType.getText().equals("By Doctor")
					|| eventType.getText().equals("By Operatory") || eventType.getText().equals("By Room")
					|| eventType.getText().equals("By Scanner")) {
			} else {
...
//		BaseClass.executeScript(eventListingpage.getResetBtnOnEvent());
	...
	public static void selectDoctor(String doctor) {
		...
		WebElement ele = driver.findElement(
				By.xpath("//span[@class='glyphicon glyphicon-chevron-down customComboBtn cursor-pointer']"));
		ele.click();
		WebElement element = driver
				.findElement(By.xpath("//ul[@class='menu fnt_cali']/li[contains(text(),'" + doctor + "')]"));
	...
	public static void verifyDateTimeDisplayOnEventList(String eventTitle, String expectedDateTimeOnEventListing) {
		BaseClass.waitForPageLoad();
		BaseClass.waitForSpinnerToDisappear();
		String actualDateTimeOfEvent = driver
				.findElement(By.xpath("//tr[@data-ng-repeat='record in eventListData']//td[contains(normalize-space(),'"
						+ eventTitle + "')]/preceding-sibling::td[2]"))
				.getText().trim();
	...
	public static void verifyDurationDisplayOnEventList(String eventTitle, String expectedDurationOfEvent) {
		BaseClass.waitForPageLoad();
		BaseClass.waitForSpinnerToDisappear();
		String actualDurationOfEvent = driver
				.findElement(By.xpath("//tr[@data-ng-repeat='record in eventListData']//td[contains(normalize-space(),'"
						+ eventTitle + "')]/preceding-sibling::td[1]"))
				.getText().trim();
	...
	public static void verifyEventTypeDisplayOnEventList(String eventTitle, String expectedEventType) {
		BaseClass.waitForPageLoad();
		String actualTypeOfEvent = driver
				.findElement(By.xpath("//tr[@data-ng-repeat='record in eventListData']//td[contains(normalize-space(),'"
						+ eventTitle + "')]/following-sibling::td[1]"))
				.getText().trim();
	...
	public static void verifyCategoryDisplayOnEventList(String eventTitle, String expectedCategoryOfEvent) {
		BaseClass.waitForPageLoad();
		String actualCategoryOfEvent = driver
				.findElement(By.xpath("//tr[@data-ng-repeat='record in eventListData']//td[contains(normalize-space(),'"
						+ eventTitle + "')]/following-sibling::td[2]"))
				.getText().trim();
	...
	public static void verifyDoctorDisplayOnEventList(String eventTitle, String expectedEventDoctor) {
		BaseClass.waitForPageLoad();
		String actualEventDoctor = driver
				.findElement(By.xpath("//tr[@data-ng-repeat='record in eventListData']//td[contains(normalize-space(),'"
						+ eventTitle + "')]/following-sibling::td[3]"))
				.getText();
	...
	public static void verifyClinicDisplayOnEventList(String eventTitle, String expectedEventClinic) {
		BaseClass.waitForPageLoad();
		String actualEventClinic = driver
				.findElement(By.xpath("//tr[@data-ng-repeat='record in eventListData']//td[contains(normalize-space(),'"
						+ eventTitle + "')]/following-sibling::td[4]"))
				.getText().trim();
	...
	public static void verifyNotesDisplayOnEventList(String eventTitle, String expectedEventNotes) {
		BaseClass.waitForPageLoad();
		String actualEventNotes = driver
				.findElement(By.xpath("//tr[@data-ng-repeat='record in eventListData']//td[contains(normalize-space(),'"
						+ eventTitle + "')]/following-sibling::td[5]"))
				.getText().trim();
	...
	public static void verifyAllMandatoryWebElement() {
		BaseClass.waitForPageLoad();
		boolean isAllMandatoryFieldDisplayed = eventListingpage.getEventFromDate().isDisplayed()
				&& eventListingpage.getEventToDate().isDisplayed()
				&& eventListingpage.getSelectEventType().isDisplayed()
				&& eventListingpage.getSelEventCat().isDisplayed()
				&& eventListingpage.getSearchBtnOnEvent().isDisplayed()
				&& eventListingpage.getResetBtnOnEvent().isDisplayed()
				&& clinicAppointmentsPage.docDropDoownBtn.isDisplayed()
				&& eventListingpage.getAddEventBtnOnEvent().isDisplayed();
	...
	public static void verifyEditAndDeletBtn(String eventTitle) {
		...
		WebElement editBtn = driver.findElement(By.xpath(
				"//td[normalize-space()='" + eventTitle + "']/following-sibling::td//span[@class='actn-icn edit']"));
		WebElement deleteBtn = driver.findElement(By.xpath(
				"//td[normalize-space()='" + eventTitle + "']/following-sibling::td//span[@class='actn-icn delete']"));
	...
	public static void checkFrmDateIsNotLaterToToDate() {
		...
		Assert.assertTrue(
				eventListingpage.getMsgFrmDateLater().getText().contains("From date cannot be greater than to date!"));
	}
	...
	public static void verifyFilterDoctorInEventList(String doctorNickName) {
		...
		while (currentPage <= lastPageNumber) {
			...
			List<WebElement> allDoctor = driver.findElements(By.xpath("//table[@id='eventListing']/tbody/tr/td[6]"));
			int allDoctorSize = allDoctor.size();
			List<WebElement> filterDoctor = driver.findElements(
					By.xpath("//table[@id='eventListing']/tbody/tr/td[normalize-space()='" + doctorNickName + "']"));
			List<WebElement> allDoctorFilter = driver
					.findElements(By.xpath("//table[@id='eventListing']/tbody/tr/td[normalize-space()='All Doctors']"));
	...
	public static void verifyFilterEventTypeInEventList(String eventType) {
		...
		while (currentPage <= lastPageNumber) {
			BaseClass.waitForPageLoad();
			List<WebElement> eventTypeList = driver
					.findElements(By.xpath("//table[@id='eventListing']/tbody/tr/td[4]"));
	...
	public static void verifyFilterCategoryInEventList(String filterCategory) {
		...
		while (currentPage <= lastPageNumber) {
			BaseClass.waitForPageLoad();
			List<WebElement> eventCategoryList = driver
					.findElements(By.xpath("//table[@id='eventListing']/tbody/tr/td[5]"));
	...
	public static void verifyResetBtnWorking() {
		...
		clickonResetBtn();
		BaseClass.waitForSpinnerToDisappear();
		boolean flag = eventListingpage.getSelectEventType().getText().contains("Select Type")
				&& eventListingpage.getSelEventCat().getText().contains("Select Category");
	...
	public static String getSelectedFromDateOnEventListing() {
		...
		String fromDate = (String) javascriptExecutor
				.executeScript("return document.getElementById('fromDate').value;");
		return fromDate;
