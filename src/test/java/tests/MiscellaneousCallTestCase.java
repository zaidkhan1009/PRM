...
//		BasePatientLifeCyclePageActions.noRecordMsgDisplayed();
	...
	public void addMiscellaneousCall() {
		...
		MiscellaneousCallListingPageActions.checkDateTimeMainList(miscellaneousCallData.get("mobileNumber"), TODAY_DATE, CURRENT_TIME);
		MiscellaneousCallListingPageActions.nameInMainList(TODAY_DATE,miscellaneousCallData.get("mobileNumber"),miscellaneousCallData.get("call_name"));
		MiscellaneousCallListingPageActions.miscellaneousCallList(TODAY_DATE,miscellaneousCallData.get("call_name"),miscellaneousCallData.get("mobileNumber"));
		MiscellaneousCallListingPageActions.miscellaneousCallList(TODAY_DATE,miscellaneousCallData.get("mobileNumber"),miscellaneousCallData.get("call_type"));
		MiscellaneousCallListingPageActions.miscellaneousCallList(TODAY_DATE,miscellaneousCallData.get("mobileNumber"),miscellaneousCallData.get("call_disposition"));
		MiscellaneousCallListingPageActions.miscellaneousCallList(TODAY_DATE,miscellaneousCallData.get("mobileNumber"),miscellaneousCallData.get("call_info"));
...
//		
	...
	public void verifyNameMobileSearchFilter() {
		...
		MiscellaneousCallListingPageActions.clickSearchBtn();
		MiscellaneousCallListingPageActions.verifyDataOnNameSearchFilter(miscellaneousCallData.get("patientName_details"));
		MiscellaneousCallListingPageActions.clickOnResetBtn();
		
		MiscellaneousCallListingPageActions.addDetails(miscellaneousCallData.get("patientMobile_details"));
		MiscellaneousCallListingPageActions.clickSearchBtn();
		MiscellaneousCallListingPageActions.verifyDataOnMobileNumberSearchFilter(miscellaneousCallData.get("patientMobile_details"));
		MiscellaneousCallListingPageActions.clickOnResetBtn();
