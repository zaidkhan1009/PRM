...
public class PrescriptionTestCase extends BaseClass {
	...
	public void addPrescription() {
		...
		PrescriptionPageActions.verifyDurationInputListData(patntPresData.get("duration"),patntPresData.get("duration_dropdown"));
		...
		PrescriptionListingPageActions.prescriptionInMainList(patntPresData.get("brand_name"),patntPresData.get("brand_name"));
		PrescriptionListingPageActions.genericNameInMainList(patntPresData.get("brand_name"),patntPresData.get("generic_name"));
		PrescriptionListingPageActions.strengthMainList(patntPresData.get("brand_name"),patntPresData.get("strength"),patntPresData.get("drug"));
		PrescriptionListingPageActions.durationMainList(patntPresData.get("brand_name"),patntPresData.get("duration"),patntPresData.get("duration_dropdown"));
		PrescriptionListingPageActions.prescriptionInMainList(patntPresData.get("brand_name"),patntPresData.get("route"));
		PrescriptionListingPageActions.prescriptionInMainList(patntPresData.get("brand_name"),patntPresData.get("instruction"));
		...
		PrescriptionListingPageActions.checkedPrescriptionInView(patntPresData.get("brand_name"),patntPresData.get("brand_name"));
		PrescriptionListingPageActions.checkedGenericNameInView(patntPresData.get("brand_name"),patntPresData.get("generic_name"));
		PrescriptionListingPageActions.strengthInView(patntPresData.get("brand_name"),patntPresData.get("strength"),patntPresData.get("drug"));
		PrescriptionListingPageActions.durationInView(patntPresData.get("brand_name"),patntPresData.get("duration"),patntPresData.get("duration_dropdown"));
		PrescriptionListingPageActions.checkedPrescriptionInView(patntPresData.get("brand_name"),patntPresData.get("route"));
		PrescriptionListingPageActions.checkedPrescriptionInView(patntPresData.get("brand_name"),patntPresData.get("instruction"));
	...
	public void editPrescription() {
		...
		PrescriptionPageActions.verifyDurationInputListData(patntPresData1.get("duration"),patntPresData1.get("duration_dropdown"));
		...
		PatientDashboardPageActions.clickOnPrescriptionTestList();
		BasePatientLifeCyclePageActions.headerOnListPage("Prescription Listing");
		PrescriptionListingPageActions.prescriptionInMainList(patntPresData1.get("brand_name"),patntPresData1.get("brand_name"));
		PrescriptionListingPageActions.genericNameInMainList(patntPresData1.get("brand_name"),patntPresData1.get("generic_name"));
		PrescriptionListingPageActions.strengthMainList(patntPresData1.get("brand_name"),patntPresData1.get("strength"),patntPresData1.get("drug"));
		PrescriptionListingPageActions.durationMainList(patntPresData1.get("brand_name"),patntPresData1.get("duration"),patntPresData1.get("duration_dropdown"));
		PrescriptionListingPageActions.prescriptionInMainList(patntPresData1.get("brand_name"),patntPresData1.get("route"));
		PrescriptionListingPageActions.prescriptionInMainList(patntPresData1.get("brand_name"),patntPresData1.get("instruction"));
		...
		PrescriptionListingPageActions.verifyHeaderInView("Patient Prescription Detail");
		PrescriptionListingPageActions.checkedPrescriptionInView(patntPresData1.get("brand_name"),patntPresData1.get("brand_name"));
		PrescriptionListingPageActions.checkedGenericNameInView(patntPresData1.get("brand_name"),patntPresData1.get("generic_name"));
		PrescriptionListingPageActions.strengthInView(patntPresData1.get("brand_name"),patntPresData1.get("strength"),patntPresData1.get("drug"));
		PrescriptionListingPageActions.durationInView(patntPresData1.get("brand_name"),patntPresData1.get("duration"),patntPresData1.get("duration_dropdown"));
		PrescriptionListingPageActions.checkedPrescriptionInView(patntPresData1.get("brand_name"),patntPresData1.get("route"));
		PrescriptionListingPageActions.checkedPrescriptionInView(patntPresData1.get("brand_name"),patntPresData1.get("instruction"));
