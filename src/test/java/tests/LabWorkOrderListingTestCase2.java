...
public class LabWorkOrderListingTestCase2 extends BaseClass {
	...
	public void checkSuspendRelatedScenarioOnLabWorkOrder() {
		...
		TreatmentPlanListingPageActions.selectTreatmentInTreatmentListPage(ExcelReader.readExcelData(FILE_PATH, SHEET, 20,2 ));
		...
		LabWorkOrderEditPageActions.addFile("D:\\Clone\\prmautomation\\PatientFiles\\"+ExcelReader.readExcelData(FILE_PATH, SHEET, 2,21));
		...
		LabWorkOrderEditPageActions.selectConfigurations(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,17), ExcelReader.readExcelData(FILE_PATH, SHEET, 2,18));
		...
		WorksDonePageActions.clickLWOBtnWD();
		BasePatientLifeCyclePageActions.headerOnAddPage("Lab Work Order Listing");
		LabWorkOrderListingPageActions.checkInActiveEntry(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,4),ExcelReader.readExcelData(FILE_PATH, SHEET, 1,7),"Trt. Suspended");
		LabWorkOrderListingPageActions.checkInActiveRevisionReasonMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,4), ExcelReader.readExcelData(FILE_PATH, SHEET, 1,7), ExcelReader.readExcelData(FILE_PATH, SHEET, 4,8));
		LabWorkOrderListingPageActions.checkInActiveViewBtn(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,4),ExcelReader.readExcelData(FILE_PATH, SHEET, 1,7));
		LabWorkOrderListingPageActions.checkDateTimeMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4), START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.checkSourceForSuspAndRetreatMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,4));
		LabWorkOrderListingPageActions.checkSourceMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4));
		LabWorkOrderListingPageActions.checkRevisionReasonMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4), ExcelReader.readExcelData(FILE_PATH, SHEET, 2,7), ExcelReader.readExcelData(FILE_PATH, SHEET, 1,8));
		...
		LabWorkOrderListingPageActions.checkSourceForSuspendedViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,4), "Suspended");
		...
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9), START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,9), START_DATE_TIME, END_DATE_TIME);
		...
		WorksDonePageActions.clickLWOBtnWD();
		BasePatientLifeCyclePageActions.headerOnAddPage("Lab Work Order Listing");
		LabWorkOrderListingPageActions.checkStatusDateMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4),ExcelReader.readExcelData(FILE_PATH, SHEET, 4,9), START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.clickOnView(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4));
		LabWorkOrderListingPageActions.verifyHeaderInView("Lab Work Order");
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9));
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,9));
		...
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9),START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,9),START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 4,9),START_DATE_TIME, END_DATE_TIME);
		...
		WorksDonePageActions.clickLWOBtnWD();
		BasePatientLifeCyclePageActions.headerOnAddPage("Lab Work Order Listing");
		LabWorkOrderListingPageActions.checkInActiveEntry(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4),ExcelReader.readExcelData(FILE_PATH, SHEET, 2,7),"Trt. Reopened");
		LabWorkOrderListingPageActions.checkInActiveRevisionReasonMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4), ExcelReader.readExcelData(FILE_PATH, SHEET, 2,7), ExcelReader.readExcelData(FILE_PATH, SHEET, 5,8));
		LabWorkOrderListingPageActions.checkInActiveViewBtn(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4),ExcelReader.readExcelData(FILE_PATH, SHEET, 2,7));
		LabWorkOrderListingPageActions.checkDateTimeMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4), START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.checkSourceForSuspAndRetreatMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,4));
		LabWorkOrderListingPageActions.checkSourceMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4));
		LabWorkOrderListingPageActions.checkRevisionReasonMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4), ExcelReader.readExcelData(FILE_PATH, SHEET, 3,7), ExcelReader.readExcelData(FILE_PATH, SHEET, 1,8));
		LabWorkOrderListingPageActions.clickOnView(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4));
		LabWorkOrderListingPageActions.verifyHeaderInView("Lab Work Order");
		LabWorkOrderListingPageActions.checkSourceForReopenAndTrtCompleteViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,4), "Reopened");
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9));
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,9));
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9), START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,9), START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.checkRevisionNoViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,22));
		LabWorkOrderListingPageActions.verifyRevisionDateInView(START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.checkCurrentStatusViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,9));
		LabWorkOrderListingPageActions.clickViewScreenClose();
		BasePatientLifeCyclePageActions.clickOnDashBoard();
		...
		LabWorkOrderListingPageActions.clickOnView(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4));
		LabWorkOrderListingPageActions.verifyHeaderInView("Lab Work Order");
		LabWorkOrderListingPageActions.checkSourceForReopenAndTrtCompleteViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,4),ExcelReader.readExcelData(FILE_PATH, SHEET, 6,8));
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9));
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,9));
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 4,9));
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9),START_DATE_TIME, END_DATE_TIME);
...
//		newReceiptPage.saveNewReceipts();
		...
		BasePatientLifeCyclePageActions.headerOnAddPage("Lab Work Order Listing");
		LabWorkOrderListingPageActions.checkStatusDateMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4),ExcelReader.readExcelData(FILE_PATH, SHEET, 5,9), START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.clickOnView(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,4));
		LabWorkOrderListingPageActions.verifyHeaderInView("Lab Work Order");
		LabWorkOrderListingPageActions.checkSourceForReopenAndTrtCompleteViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,4),"Payment and Trt. Completed");
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9));
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,9));
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,9));
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 4,9));
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 6,9));
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9),START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 2,9),START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 3,9),START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 4,9),START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 6,9),START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.checkCurrentStatusViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 5,9));
		LabWorkOrderListingPageActions.clickViewScreenClose();
	...
	public void CheckSuspendRelatedAnotherScenerioOnLWO() {
		...
		TreatmentPlansPageActions.clickOnSaveBtnTreatmentInputList();
		TreatmentPlanListingPageActions.verifyStartBtn(TODAY_DATE);
		TreatmentPlanListingPageActions.selectTreatmentInTreatmentListPage(ExcelReader.readExcelData(FILE_PATH, SHEET, 19,2 ));
		TreatmentPlanListingPageActions.clickOnStartBtn(TODAY_DATE);
		BasePatientLifeCyclePageActions.headerOnAddPage("Works Done");
		WorksDonePageActions.clickLWOBtnWD();
		BasePatientLifeCyclePageActions.headerOnAddPage("Lab Work Order Listing");
...
//		newReceiptPage.saveNewReceipts();
		...
		WorksDonePageActions.clickLWOBtnWD();
		BasePatientLifeCyclePageActions.headerOnAddPage("Lab Work Order Listing");
		LabWorkOrderListingPageActions.checkSourceForSuspAndRetreatMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 4,4));
		LabWorkOrderListingPageActions.checkDateTimeMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 4,4), START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.checkSourceMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 4,4));
		LabWorkOrderListingPageActions.checkRevisionReasonMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 4,4), ExcelReader.readExcelData(FILE_PATH, SHEET, 1,7), ExcelReader.readExcelData(FILE_PATH, SHEET, 1,8));
		LabWorkOrderListingPageActions.checkStatusDateMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 4,4), ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9), START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.clickOnView(ExcelReader.readExcelData(FILE_PATH, SHEET, 4,4));
		LabWorkOrderListingPageActions.verifyHeaderInView("Lab Work Order");
		LabWorkOrderListingPageActions.checkSourceViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 4,4), ExcelReader.readExcelData(FILE_PATH, SHEET, 4,4));
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9));
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9), START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.clickViewScreenClose();
		Assert.assertTrue(CommonPageActions.verification().contains("Lab Work Order Listing"));
	...
	public void checkbridgeableRelatedScenerio() {
		...
		TreatmentPlansPageActions.checkTreatmentsIsSelectedAsBridgeable(ExcelReader.readExcelData(FILE_PATH, SHEET, 21,1 ));
		TreatmentPlansPageActions.saveTreatment();
		TreatmentPlansPageActions.clickOnSaveBtnTreatmentInputList();
		TreatmentPlanListingPageActions.verifyStartBtn(TODAY_DATE);
		TreatmentPlanListingPageActions.selectTreatmentInTreatmentListPage(ExcelReader.readExcelData(FILE_PATH, SHEET, 21,2 ));
		TreatmentPlanListingPageActions.clickOnStartBtn(TODAY_DATE);
		BasePatientLifeCyclePageActions.headerOnAddPage("Works Done");
		WorksDonePageActions.clickLWOBtnWD();
		BasePatientLifeCyclePageActions.headerOnAddPage("Lab Work Order Listing");
		...
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9 ));
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9 ), START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.verifyTreatmentNameView(ExcelReader.readExcelData(FILE_PATH, SHEET, 21,1), 2);
		LabWorkOrderListingPageActions.clickViewScreenClose();
		Assert.assertTrue(CommonPageActions.verification().contains("Lab Work Order Listing"));
	}
	...
	public void checkByArchRelatedScenario() {
		...
		TreatmentPlansPageActions.clickOnSaveBtnTreatmentInputList();
		TreatmentPlanListingPageActions.verifyStartBtn(TODAY_DATE);
		TreatmentPlanListingPageActions.selectTreatmentInTreatmentListPage(ExcelReader.readExcelData(FILE_PATH, SHEET, 22,2 ));
		TreatmentPlanListingPageActions.clickOnStartBtn(TODAY_DATE);
		BasePatientLifeCyclePageActions.headerOnAddPage("Works Done");
		WorksDonePageActions.clickLWOBtnWD();
		BasePatientLifeCyclePageActions.headerOnAddPage("Lab Work Order Listing");
		LabWorkOrderListingPageActions.checkClinicNameMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4 ),CLINIC_NAME);
		LabWorkOrderListingPageActions.checkLabNameMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4 ), ExcelReader.readExcelData(FILE_PATH, SHEET, 1,0 ));
		LabWorkOrderListingPageActions.checkDateMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4),TODAY_DATE );
		LabWorkOrderListingPageActions.checkOrderTypeMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4 ),ExcelReader.readExcelData(FILE_PATH, SHEET, 1,1 ));
		LabWorkOrderListingPageActions.checkLabWorkOrderNo(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4));
		LabWorkOrderListingPageActions.checkDateTimeMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4), START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.checkWorkDetailsMainlist(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4),ExcelReader.readExcelData(FILE_PATH, SHEET, 4,2));
		LabWorkOrderListingPageActions.checkSourceMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4));
		LabWorkOrderListingPageActions.checkDoctorMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4),DOCTOR_FIRST_NAME);
		LabWorkOrderListingPageActions.checkItemSentMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4),ExcelReader.readExcelData(FILE_PATH, SHEET, 1,5));
		LabWorkOrderListingPageActions.checkRevisionReasonMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4),ExcelReader.readExcelData(FILE_PATH, SHEET, 1,7),ExcelReader.readExcelData(FILE_PATH, SHEET, 1,8));
		LabWorkOrderListingPageActions.checkStatusDateMainList(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4),ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9), START_DATE_TIME, END_DATE_TIME);
		...
		LabWorkOrderListingPageActions.checkOrderTypeViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,1));
		LabWorkOrderListingPageActions.checkWorkDetailViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 4,2));
		LabWorkOrderListingPageActions.checkOtherInfoViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,3));
		LabWorkOrderListingPageActions.checkSourceViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 7,4),ExcelReader.readExcelData(FILE_PATH, SHEET, 1,4));
		...
		LabWorkOrderListingPageActions.checkShadeViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,11),ExcelReader.readExcelData(FILE_PATH, SHEET, 1,11));
		LabWorkOrderListingPageActions.checkStainsInternalViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,13));
		LabWorkOrderListingPageActions.checkStainsExternalViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,14));
		LabWorkOrderListingPageActions.checkTranslucencyViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,15));
		LabWorkOrderListingPageActions.checkTextureViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,16));
		LabWorkOrderListingPageActions.checkConfigurationsViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,17),ExcelReader.readExcelData(FILE_PATH, SHEET, 1,17));
		LabWorkOrderListingPageActions.checkSurfaceDetailsViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,19),"NA");
		LabWorkOrderListingPageActions.checkNotesViewList(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,20));
		LabWorkOrderListingPageActions.checkStatusEnableInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9));
		LabWorkOrderListingPageActions.verifyStatusInView(ExcelReader.readExcelData(FILE_PATH, SHEET, 1,9),START_DATE_TIME, END_DATE_TIME);
		LabWorkOrderListingPageActions.verifyTreatmentNameView(ExcelReader.readExcelData(FILE_PATH, SHEET, 22,1),1);
		LabWorkOrderListingPageActions.clickViewScreenClose();
		Assert.assertTrue(CommonPageActions.verification().contains("Lab Work Order Listing"));
	}
