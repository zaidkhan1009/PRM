...
//		EventPageActions.verifyEventAddSuccessMsg();
		...
		EventListingPageActions.verifyDateTimeDisplayOnEventList( addDoctorEventTestData.get("event_Title"), addDoctorEventTestData.get("event_DateTime"));
		EventListingPageActions.verifyDurationDisplayOnEventList( addDoctorEventTestData.get("event_Title"), addDoctorEventTestData.get("event_duration"));
		...
		EventListingPageActions.verifyCategoryDisplayOnEventList( addDoctorEventTestData.get("event_Title"), addDoctorEventTestData.get("category"));
		EventListingPageActions.verifyDoctorDisplayOnEventList( addDoctorEventTestData.get("event_Title"),addDoctorEventTestData.get("doctor_nickName"));
		EventListingPageActions.verifyClinicDisplayOnEventList(addDoctorEventTestData.get("event_Title"),addDoctorEventTestData.get("event_Clinic"));
		EventListingPageActions.verifyNotesDisplayOnEventList( addDoctorEventTestData.get("event_Title"), addDoctorEventTestData.get("event_notes"));
		...
		CommonPageActions.selectClinicFrmHeader(addDoctorEventTestData.get("event_Clinic"));
		DoctorDashBoardPageActions.clickonAppointmentAdd();
		EventPageActions.checkEventAddedDoctorIsDisable(addDoctorEventTestData.get("event_On"),
	 ...
	 ** having a Event
	 */
	@Test(groups = {"Functional","Regression"},description = VERIFY_DOC_IF_ALREADY_EVENT_ON_SAME_TIME,dependsOnMethods = "verifyAddingByDoctorEvent")
	 ...
	 */
	@Test(groups = {"Sanity","Functional","Regression"},description =VERIFY_BY_DOCTOR_EVENT_UPDATE, dependsOnMethods = "verifyAddingByDoctorEvent")
	public void verifyUpdateDoctorEvent(){
		...
		EventListingPageActions.clickOnSearch();
		EventListingPageActions.verifyDateTimeDisplayOnEventList(updateDoctorEventTestData.get("event_Title"), updateDoctorEventTestData.get("event_DateTime"));
		EventListingPageActions.verifyDurationDisplayOnEventList(updateDoctorEventTestData.get("event_Title"), updateDoctorEventTestData.get("event_duration"));
		EventListingPageActions.verifyTitleDisplayOnEventlist(updateDoctorEventTestData.get("event_Title"));
		EventListingPageActions.verifyEventTypeDisplayOnEventList(updateDoctorEventTestData.get("event_Title"),"Doctor");
		EventListingPageActions.verifyCategoryDisplayOnEventList(updateDoctorEventTestData.get("event_Title"),  updateDoctorEventTestData.get("category"));
		EventListingPageActions.verifyDoctorDisplayOnEventList(updateDoctorEventTestData.get("event_Title"), updateDoctorEventTestData.get("doctor_nickName"));
		EventListingPageActions.verifyClinicDisplayOnEventList(updateDoctorEventTestData.get("event_Title"),updateDoctorEventTestData.get("event_Clinic"));
		EventListingPageActions.verifyNotesDisplayOnEventList(updateDoctorEventTestData.get("event_Title"), updateDoctorEventTestData.get("event_notes"));
	 ...
	 */
	@Test(groups = {"Functional","Regression"},description = VERIFY_BY_DOCTOR_EVENT_DELETED,dependsOnMethods = "verifyUpdateDoctorEvent")
	public void verifyDeleteDoctorEvent(){
		...
		EventListingPageActions.clickOnNoBtnDeletePopUp();
		EventListingPageActions.clickOnDeleteBtn(updateDoctorEventTestData.get("event_Title"));
...
//		EventPageActions.verifyEventDeleteSuccessMsg ();
	 ...
	 *
	 */
	@Test(groups = {"Functional","Regression"},description = VERIFY_ADD_EVENT_FOR_ALREADY_BOOKED_APPOINTMENT_TIME,priority = 1)
	public void verifyAddEventIfAppointmentAlreadyBookedForTime() throws ParseException, java.text.ParseException {
		...
		EventPageActions.enterHours(BaseClass.convert24HourFormatTo12HourFormat(confirmedAppointmentTestData.get("slot")).split(":")[0]);
		EventPageActions.enterMinutes(BaseClass.convert24HourFormatTo12HourFormat(confirmedAppointmentTestData.get("slot")).split(":")[1]);
		EventPageActions.selectAmPm(BaseClass.convert24HourFormatTo12HourFormat(confirmedAppointmentTestData.get("slot")).split(" ")[1].toUpperCase());
...
//		EventPageActions.verifyEventAddSuccessMsg ();
		...
		EventListingPageActions.clickOnSearch();
		EventListingPageActions.verifyDateTimeDisplayOnEventList(addOperatoryEventTestData.get("event_Title"),addOperatoryEventTestData.get("event_DateTime"));
		EventListingPageActions.verifyDurationDisplayOnEventList(addOperatoryEventTestData.get("event_Title"),addOperatoryEventTestData.get("event_duration"));
		EventListingPageActions.verifyTitleDisplayOnEventlist(addOperatoryEventTestData.get("event_Title"));
		EventListingPageActions.verifyEventTypeDisplayOnEventList(addOperatoryEventTestData.get("event_Title"),addOperatoryEventTestData.get("event_On"));
		EventListingPageActions.verifyCategoryDisplayOnEventList(addOperatoryEventTestData.get("event_Title"), addOperatoryEventTestData.get("category"));
		EventListingPageActions.verifyDoctorDisplayOnEventList(addOperatoryEventTestData.get("event_Title"), "NA");
		EventListingPageActions.verifyClinicDisplayOnEventList(addOperatoryEventTestData.get("event_Title"),addOperatoryEventTestData.get("event_Clinic"));
		EventListingPageActions.verifyNotesDisplayOnEventList(addOperatoryEventTestData.get("event_Title"), addOperatoryEventTestData.get("event_notes"));
	 ...
	 *
	 */
	@Test(groups = {"Functional","Regression"},description = VERIFY_ADDING_EVENT_ON_LAST_AVAILABLE_OPERATORY,dependsOnMethods = "verifyByOperatoryEvent")
	 ...
	 */
	@Test(groups = {"Functional","Regression"},description = VERIFY_BY_OPERATORY_EVENT_UPDATE,dependsOnMethods = "verifyByOperatoryEvent")
...
////		EventPageActions.verifyEventUpdatedSuccessMsg ();
		...
		DoctorDashBoardPageActions.clickOnAppListBtn();
		EventListingPageActions.clickOnEventBtn();
		EventListingPageActions.verifyDateTimeDisplayOnEventList(updateOperatoryEventTestData.get("event_Title"),updateOperatoryEventTestData.get("event_DateTime"));
		EventListingPageActions.verifyDurationDisplayOnEventList(updateOperatoryEventTestData.get("event_Title"),updateOperatoryEventTestData.get("event_duration"));
		EventListingPageActions.verifyTitleDisplayOnEventlist(updateOperatoryEventTestData.get("event_Title"));
		EventListingPageActions.verifyEventTypeDisplayOnEventList(updateOperatoryEventTestData.get("event_Title"),updateOperatoryEventTestData.get("event_On"));
		EventListingPageActions.verifyCategoryDisplayOnEventList(updateOperatoryEventTestData.get("event_Title"), updateOperatoryEventTestData.get("category"));
		EventListingPageActions.verifyDoctorDisplayOnEventList(updateOperatoryEventTestData.get("event_Title"), "NA");
		EventListingPageActions.verifyClinicDisplayOnEventList(updateOperatoryEventTestData.get("event_Title"),updateOperatoryEventTestData.get("event_Clinic"));
		EventListingPageActions.verifyNotesDisplayOnEventList(updateOperatoryEventTestData.get("event_Title"),updateOperatoryEventTestData.get("event_notes"));
	...
	@Test(groups = {"Functional","Regression"},description = VERIFY_BY_OPERATORY_EVENT_DELETED,dependsOnMethods = "verifyUpdateByOperatoryEvent")
...
//		EventPageActions.verifyEventDeleteSuccessMsg ();
	 ...
	 * */
	@Test(groups = {"Functional","Regression"},description = VERIFY_ADDING_EVENT_FOR_A_SLOT_FOR_WHICH_TENTATIVE_APPT_ALREADY_BOOKED)
	public void verifyAddEventIfTentativeAppointmentAlreadyBookedForTime() throws ParseException, java.text.ParseException {
		...
		EventPageActions.enterHours(BaseClass.convert24HourFormatTo12HourFormat(tentativeAppointmentTestData.get("slot")).split(":")[0]);
		EventPageActions.enterMinutes(BaseClass.convert24HourFormatTo12HourFormat(tentativeAppointmentTestData.get("slot")).split(":")[1]);
		EventPageActions.selectAmPm(BaseClass.convert24HourFormatTo12HourFormat(tentativeAppointmentTestData.get("slot")).split(" ")[1].toUpperCase());
		EventPageActions.enterEventDuration(tentativeAppointmentTestData.get("duration"));
		EventPageActions.enterNotes(addDoctorEventTestData.get("notes"));
		EventPageActions.clickOnEventSaveBtn();
//		EventPageActions.verifyEventAddSuccessMsg ();
		CommonPageActions.selectClinicFrmHeader(tentativeAppointmentTestData.get("clinicLocation"));
		DoctorDashBoardPageActions.clickonAppointmentAdd();
...
//		EventPageActions.verifyEventAddSuccessMsg ();
		...
		EventListingPageActions.clickOnSearch();
		EventListingPageActions.verifyDateTimeDisplayOnEventList(addRoomEventTestData.get("event_Title"),addRoomEventTestData.get("event_DateTime"));
		EventListingPageActions.verifyDurationDisplayOnEventList(addRoomEventTestData.get("event_Title"), addRoomEventTestData.get("event_duration"));
		EventListingPageActions.verifyTitleDisplayOnEventlist(addRoomEventTestData.get("event_Title"));
		EventListingPageActions.verifyEventTypeDisplayOnEventList(addRoomEventTestData.get("event_Title"), addRoomEventTestData.get("event_On"));
		EventListingPageActions.verifyCategoryDisplayOnEventList(addRoomEventTestData.get("event_Title"), addRoomEventTestData.get("category"));
		EventListingPageActions.verifyDoctorDisplayOnEventList(addRoomEventTestData.get("event_Title"), "NA");
		EventListingPageActions.verifyClinicDisplayOnEventList(addRoomEventTestData.get("event_Title"),addRoomEventTestData.get("event_Clinic"));
		EventListingPageActions.verifyNotesDisplayOnEventList(addRoomEventTestData.get("event_Title"), addRoomEventTestData.get("event_DateTime"));
	...
	@Test(groups = {"Functional","Regression"},description = VERIFY_BY_ROOM_EVENT_UPDATE,dependsOnMethods = "verifyByRoomEvent")
	public void verifyUpdateByRoomEvent(){
		...
		DoctorDashBoardPageActions.clickOnAppListBtn();
		EventListingPageActions.clickOnEventBtn();
		EventListingPageActions.verifyDateTimeDisplayOnEventList(updateRoomEventTestData.get("event_Title"),updateRoomEventTestData.get("event_DateTime"));
		EventListingPageActions.verifyDurationDisplayOnEventList(updateRoomEventTestData.get("event_Title"), updateRoomEventTestData.get("event_duration"));
		EventListingPageActions.verifyTitleDisplayOnEventlist(updateRoomEventTestData.get("event_Title"));
		EventListingPageActions.verifyEventTypeDisplayOnEventList(updateRoomEventTestData.get("event_Title"),updateRoomEventTestData.get("event_On"));
		EventListingPageActions.verifyCategoryDisplayOnEventList(updateRoomEventTestData.get("event_Title"), updateRoomEventTestData.get("category"));
		EventListingPageActions.verifyDoctorDisplayOnEventList( updateRoomEventTestData.get("event_Title"), "NA");
		EventListingPageActions.verifyClinicDisplayOnEventList(updateRoomEventTestData.get("event_Title"), updateRoomEventTestData.get("event_Clinic"));
		EventListingPageActions.verifyNotesDisplayOnEventList(updateRoomEventTestData.get("event_Title"), updateRoomEventTestData.get("event_notes"));
	...
	@Test(groups = {"Functional","Regression"},description = VERIFY_BY_ROOM_EVENT_DELETED,dependsOnMethods = "verifyUpdateByRoomEvent")
	...
	public void verifyByScannerEvent() {
		...
		EventListingPageActions.clickOnSearch();
		EventListingPageActions.verifyDateTimeDisplayOnEventList( addScannerRoomEvent.get("event_Title"),addScannerRoomEvent.get("event_DateTime"));
		EventListingPageActions.verifyDurationDisplayOnEventList( addScannerRoomEvent.get("event_Title"), addScannerRoomEvent.get("event_duration"));
		EventListingPageActions.verifyTitleDisplayOnEventlist(addScannerRoomEvent.get("event_Title"));
		EventListingPageActions.verifyEventTypeDisplayOnEventList( addScannerRoomEvent.get("event_Title"),addScannerRoomEvent.get("event_On"));
		EventListingPageActions.verifyCategoryDisplayOnEventList( addScannerRoomEvent.get("event_Title"), addScannerRoomEvent.get("category"));
		EventListingPageActions.verifyDoctorDisplayOnEventList( addScannerRoomEvent.get("event_Title"), "NA");
		EventListingPageActions.verifyClinicDisplayOnEventList(addScannerRoomEvent.get("event_Title"),addScannerRoomEvent.get("event_Clinic"));
		EventListingPageActions.verifyNotesDisplayOnEventList( addScannerRoomEvent.get("event_Title"), addScannerRoomEvent.get("event_notes"));
	 ...
	 *
	 */
	@Test(groups = {"Functional","Regression"},description = VERIFY_ADDING_EVENT_ON_LAST_AVAILABLE_SCANNER,dependsOnMethods = "verifyByScannerEvent")
	 ...
	 *
	 */
	@Test(groups = {"Functional","Regression"},description = VERIFY_BY_SCANNER_EVENT_UPDATE,dependsOnMethods = "verifyByScannerEvent")
	public void verifyUpdateByScannerEvent(){
		...
		DoctorDashBoardPageActions.clickOnAppListBtn();
		EventListingPageActions.clickOnEventBtn();
		EventListingPageActions.verifyDateTimeDisplayOnEventList(updateScannerRoomEvent.get("event_Title"),updateScannerRoomEvent.get("event_DateTime"));
		EventListingPageActions.verifyDurationDisplayOnEventList(updateScannerRoomEvent.get("event_Title"),updateScannerRoomEvent.get("event_duration"));
		EventListingPageActions.verifyTitleDisplayOnEventlist(updateScannerRoomEvent.get("event_Title"));
		EventListingPageActions.verifyEventTypeDisplayOnEventList(updateScannerRoomEvent.get("event_Title"),updateScannerRoomEvent.get("event_On"));
		EventListingPageActions.verifyCategoryDisplayOnEventList(updateScannerRoomEvent.get("event_Title"), updateScannerRoomEvent.get("category"));
		EventListingPageActions.verifyDoctorDisplayOnEventList(updateScannerRoomEvent.get("event_Title"), "NA");
		EventListingPageActions.verifyClinicDisplayOnEventList(updateScannerRoomEvent.get("event_Title"),updateScannerRoomEvent.get("event_Clinic"));
		EventListingPageActions.verifyNotesDisplayOnEventList(updateScannerRoomEvent.get("event_Title"), updateScannerRoomEvent.get("event_notes"));
	...
	@Test(groups = {"Functional","Regression"},description = VERIFY_BY_SCANNER_EVENT_DELETED,dependsOnMethods = "verifyUpdateByScannerEvent")
...
//		EventPageActions.verifyEventAddSuccessMsg ();
	...
	public void verifyDoctorFilterWithDateFilterOnEventList () {
		...
		EventListingPageActions.clickOnSearch();
		EventListingPageActions.dateFilter(EventPageActions.getCurrentDate (),
				EventPageActions.getCurrentDate ());
